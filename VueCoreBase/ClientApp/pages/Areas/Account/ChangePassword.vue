<template>
    <form @submit.prevent="setSubmit" class="p-2">
        ...
        <vee-form-input :formInput="currentPassword"></vee-form-input>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                oldPassword: formObject('Current Password'),
                newPassword: formObject('New Password'),
                ...
                this.$validator.validateAll().then(
                    result => {
                        if (result) {
                            ...
                            axios
                                .post(apiRoutes.account.changePasswordUrl, payload)
                                .then(response => {
                                    this.serverErr = [];
