<template>
    <form @submit.prevent="resetSubmit" class="p-2">
    ...
    export default {
        ...
        data() {
            return {
                ...
                successMessage: 'Password Reset. Login with your email and new password.',
                serverErr: [],
                registered: false
            };
        },
                ...
                this.$validator.validateAll().then(
                    result => {
                        if (result) {
                            ...
                            axios
                                .post(apiRoutes.account.resetPasswordUrl, payload)
                                .then(response => {
                                    this.serverErr = [];
                                    this.login.value = "";
                                    this.password.value = "";
